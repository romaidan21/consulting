...
<section id="welcome" class="welcome">
  <div class="welcome__text">
    <div class="icon">
      <?php svg_embed('smart.svg'); ?>
    </div>
    <p class="title before"><?php the_field('s1-subtitle'); ?></p>
    <p class="desc"><?php the_field('s1-text'); ?></p>



    <a href="#experience" class="button black"><?php _e('Наш досвід', 'smart'); ?></a>



  </div>
  <div class="welcome__icon">
      <img src="<?php assets()?>img/icon.svg" alt="">
  </div>
</section>
